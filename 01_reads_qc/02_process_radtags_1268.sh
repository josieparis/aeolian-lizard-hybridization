...
output_dir=$MASTER/outputs/process_radtags_1268

## run 
process_radtags \
		-1 $input_dir/180209_SND405_A_L002_GWM-1268_R1.clean.fastq.gz \
		-2 $input_dir/180209_SND405_A_L002_GWM-1268_R2.clean.fastq.gz \
		-b $barcode_dir/library_1268_barcodes.tsv \
		-o $output_dir \
		-e sbfI \
		--renz_2 mspI \
		-q -c -r
