...
output_dir=$MASTER/outputs/process_radtags_1267

## run 
process_radtags \
		-1 $input_dir/180209_SND405_A_L002_GWM-1267_R1.clean.fastq.gz \
		-2 $input_dir/180209_SND405_A_L002_GWM-1267_R2.clean.fastq.gz \
		-b $barcode_dir/library_1267_barcodes.tsv \
		-o $output_dir \
		-e sbfI \
		--renz_2 mspI \
		-q -c -r
