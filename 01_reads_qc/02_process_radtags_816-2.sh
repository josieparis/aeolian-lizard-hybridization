...
output_dir=$MASTER/outputs/process_radtags_816-2

## run 
process_radtags \
		-1 $input_dir/160701_SND405_A_L008_GWM-816-2_R1.clean.fastq.gz \
		-2 $input_dir/160701_SND405_A_L008_GWM-816-2_R2.clean.fastq.gz \
		-b $barcode_dir/library_816-2_barcodes.tsv \
		-o $output_dir \
		-e sbfI \
		--renz_2 mspI \
		-q -c -r 
